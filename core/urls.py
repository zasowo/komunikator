...
urlpatterns = [
    ...
    path('api/update-public-key/', views.api_update_public_key, name='api_update_public_key'),
    path('api/users/<int:user_id>/public-key/', views.api_get_public_key, name='api_get_public_key'),
